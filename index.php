    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <div href="#" class="logo">
          ...
          <span class="logo-mini"><b>SMKN 07 PADANG</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>E-PERPUS</b></span>
        </div>
        ...
        <section class="sidebar" style="">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>E-PERPUS</p>
              <a href="#"><i class="fa fa-circle text-success"></i>SMKN 07 PADANG</a>
            </div>
          </div>
          ...
          <ul class="sidebar-menu">
			     <li>
              <a href="login.php">
                <i class="fa fa-sign-out"></i> <span>Login</span>
              </a>
            </li>
          </ul>
        </section>
