  ...
  <div class="col-md-12">
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Pengembalian Perbulan</h3><br>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                if (isset($_POST['lihatlaporan'])) {
                  ...
                  $tahun = $_POST['tahun'];
                  $bulan = $_POST['bulan'];
                  $a= mysqli_query($koneksi,"SELECT * FROM `tbl_pengembalian`  WHERE YEAR(tanggal_kembali) ='$tahun' AND MONTH(tanggal_kembali) ='$bulan' and status='DI KEMBALIKAN'");
                ...
                <tr>
                  <td colspan="7">
                    <form method="POST" action="cetak_pengembalian_bulan.php" target="_BLANK">
