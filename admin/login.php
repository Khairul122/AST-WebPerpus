...
<body id="bg" style="background-image: url('logo.png')">
<div class="page-wrapers">
    <!-- Content -->
    <div id="particles-js" class="page-content dez-login bg-danger-dark">
                ...
                <div id="login" class="tab-pane active text-center">
                    <form class="p-a30 dez-form" method="post" action="proses_login.php">
                        ...
                        <div class="dez-separator-outer m-b5">
                            <div class="dez-separator bg-danger style-liner"></div>
                        </div>
                     ...
                     <div class="form-group">
                            <select name="level" class="form-control">
                                <option value="perpus">Adm.Perpus</option>
		...
		<div class="bottom-footer text-center text-white">
			<p>Copyright <?= date('Y')?> © SI-PERPUS</p>
		</div>
		</div>
	</div>
	<!-- Content END-->
