  ...
  <div class="col-md-12">
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Peminjaman Pertahun</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                if (isset($_POST['lihatlaporan'])) {
                  $no = 1;
                  $tahun = $_POST['tahun'];
                    $a= mysqli_query($koneksi,"SELECT * FROM `tbl_peminjaman`  WHERE YEAR(tgl_pinjam)='$tahun'  and status='Di Pinjam'");
                ...
                <tr>
                  <td colspan="7">
                    <form method="POST" action="cetak_penjualan_tahun.php" target="_BLANK">
